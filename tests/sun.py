...
class GLFrame(OpenGLFrame):
    ...
    def redraw(self):
        ...
        glLoadIdentity()
        self.draw_sphere(mate=[1, 0, 0.2, 1.0], pos=[0, 0, 0], scale=[1.0, 1.0, 1.0])
        ...
        self.draw_sphere(
            mate=[0, 0.2, 0.8, 1.0], pos=[ex, ey, ez], scale=[0.5, 0.5, 0.5]
        )
        ...
        mz = ez
        self.draw_sphere(
            mate=[1, 0.8, 0.0, 1.0], pos=[mx, my, mz], scale=[0.2, 0.2, 0.2]
        )
    ...
    def draw_sphere(
        self, mate=[0, 0, 0.8, 0.2, 1.0], pos=[0, 0, 0], scale=[1.0, 1.0, 1.0]
    ):
        glPushMatrix()
